...
const NEWS_ITEMS = [
  {
    ...
    description:
      "TMC announces revolutionary scheme: 100% reservation for people who know the 'Humba Dumba' lyrics. EVMs to be replaced by ballot boxes guarded by Royal Bengal Tigers.",
    videoUrl: "/news/mamta.mp4",
    category: "Politics",
    warningText:
      "Warning: This video contains continuous slogan chanting. Cancel to save your eardrums.",
    cancelMessages: [
  ...
  },
  {
    ...
    description:
      "Breaking: Election Commission confirms all votes in TN will automatically be redirected to Thalapathy Vijay's new party. Democracy has left the chat.",
    videoUrl: "/news/thalapathy.mp4",
    category: "Politics",
    warningText:
      "Warning: High-intensity action sequence. Do not attempt to cancel if you are a true fan.",
    cancelMessages: [
  ...
  },
  {
    ...
    description:
      "New GST slab introduced: 28% tax on celebrating MS Dhoni. Citizens caught whistling will be fined ₹50,000.",
    videoUrl: "/news/csk.mp4",
    category: "Sports",
    warningText:
      "Warning: Video contains unauthorized yellow colors. Proceeding will alert the Income Tax Department.",
    cancelMessages: [
  ...
  },
  {
    ...
    description:
      "A comprehensive, highly detailed 10-hour documentary on unscripted press conferences.",
    videoUrl: "/news/modi.mp4",
    category: "Politics",
    warningText:
      "Warning: This documentary contains absolute silence. It is highly recommended by the ruling party.",
    cancelMessages: [
  ...
  },
  {
    ...
    description:
      "Congress party releases their ultimate campaign anthem. Experts say it will secure exactly 42 seats.",
    videoUrl: "/news/rahul.mp4",
    category: "Politics",
    warningText:
      "Warning: Viewer discretion advised. May cause uncontrollable face-palming. Watch fully to support the nation.",
    cancelMessages: [
  ...
  },
  {
    ...
    description:
      "New government scheme: Why build roads when you can just bulldoze the potholes? Mafia relocated to Mars.",
    videoUrl: "/news/yogi.mp4",
    category: "Politics",
    warningText:
      "Warning: This video will demolish your browser cache. Cancel before it reaches your hard drive.",
    cancelMessages: [
  ...
  },
  {
    ...
    description:
      "'Kab aaoge mere Akhilesh?' The Election Commission has banned this song for causing extreme depression among voters.",
    videoUrl: "/news/yadav.mp4",
    category: "Politics",
    warningText:
      "Warning: This audio contains emotional campaign songs. Do you really want to endure this?",
    cancelMessages: [
...
const COMPREHENSION_QUIZ = {
  1: {
    question:
      "According to Directive #3, what is the exact tax amount (in ₹) you now owe for 'Skipping Humba Dumba'? (Enter digits only)",
    answers: ["5000", "5,000"],
    hint: "Hint: Look at Directive #3.",
  },
  2: {
    question:
      "According to Directive #2, what card of yours will be automatically linked to a random stunt double? (e.g., voter card, aadhar card)",
    answers: ["aadhar", "aadhar card"],
    hint: "Hint: Look at Directive #2.",
  },
  3: {
    question:
      "According to Directive #3, what phrase will be tattooed on your permanent record as a warning?",
    answers: ["thala for a reason", "thala"],
    hint: "Hint: Look at Directive #3.",
  },
  4: {
    question:
      "According to Directive #3, what specific fund automatically debited ₹500 from your account as a 'Skip Fee'?",
    answers: ["pm cares", "pm cares fund"],
    hint: "Hint: Look at Directive #3.",
  },
  5: {
    question:
      "According to Directive #2, how many kilometers (km) is the mandatory foot march if you cancel? (Enter digits only)",
    answers: ["500", "500km"],
    hint: "Hint: Look at Directive #2.",
  },
  6: {
    question:
      "According to Directive #2, what has your street name been officially changed to?",
    answers: ["cancel nagar", "cancelnagar"],
    hint: "Hint: Look at Directive #2.",
  },
  7: {
    question:
      "According to Directive #2, what vehicle will be permanently parked in your living room?",
...
const NewsFeed = () => {
  ...
  useEffect(() => {
    if (
      ...
      showAnnoyingPopup ||
      rickrollActive ||
      Object.keys(watchedVideos).length === NEWS_ITEMS.length
    )
      return
            ...
            if (prev <= 1) {
              setWatchedVideos((w) => {
                ...
                if (Object.keys(next).length === NEWS_ITEMS.length) {
                  ...
                  alert(
                    "🎉 CITIZEN STATUS RESTORED! You have successfully watched all mandatory broadcasts. The navigation lock is deactivated. Thank you for your compliance!",
                  )
                }
                return next
              })
  ...
  return (
    <div className="bg-white border border-gray-300 shadow-md flex flex-col min-h-[500px] lg:h-[calc(100vh-240px)]">
      ...
      <div className="bg-[#003366] text-white p-3 border-b border-[#002244] flex justify-between items-center">
        ...
        <span className="text-xs bg-red-600 text-white px-2 py-1 rounded animate-pulse shadow-[0_0_10px_rgba(255,0,0,0.8)] border border-red-300">
          MANDATORY VIEWING
        </span>
      </div>
      ...
      <div className="p-4 bg-gray-100 flex-grow flex flex-col lg:flex-row gap-6 min-h-0">
        ...
        <div className="w-full lg:w-5/12 flex flex-col gap-4 overflow-y-auto custom-scrollbar-dark">
          ...
          <div className="bg-amber-50 border-l-4 border-amber-500 p-3.5 text-[#003366] text-[10px] sm:text-xs font-black uppercase tracking-wider rounded-lg shadow-sm flex items-center gap-2 flex-shrink-0 animate-[pulse_3s_infinite] border border-amber-200">
            <span>
              📡 Info: Hover card to preview live sound feed • Click to view
              full broadcast
            </span>
          </div>
              ...
              <div className="p-5 grow flex flex-col justify-center bg-white">
                <h4 className="font-black text-[#003366] text-xl leading-tight mb-2 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  ...
                  {watchedVideos[item.id] ? (
                    <span className="bg-emerald-100 text-emerald-800 text-[10px] font-black px-2 py-1 rounded-full border border-emerald-300 flex items-center gap-1 shadow-sm shrink-0 self-start sm:self-center">
                      ✅ VIEW APPROVED
                    </span>
                  ) : (
                    forcedConsumption && (
        ...
        <div className="w-full lg:w-7/12 flex flex-col flex-shrink-0 h-[380px] lg:h-full">
          <div className="bg-[#020617] border-4 border-gray-900 rounded-xl overflow-hidden shadow-2xl h-full flex flex-col relative animate-gentle-float">
            ...
            {hoveredVideoId ? (
              (() => {
                const activeHoverItem = NEWS_ITEMS.find(
                  (n) => n.id === hoveredVideoId,
                )
                  ...
                  <div className="flex-grow flex flex-col min-h-0 bg-black relative justify-center items-center">
                    {!activeHoverItem.videoUrl.endsWith(".mp3") ? (
                      ...
                      <div className="flex flex-col items-center justify-center p-6 text-center">
                        <span className="text-red-500 font-black text-lg animate-bounce tracking-widest mb-3">
                          🔊 AUDIO FEED ACTIVE
                        </span>
                      </div>
                    )}
              ...
              <div className="flex-grow flex flex-col justify-center items-center p-6 text-center bg-gradient-to-br from-[#0c1020] to-[#030712] text-gray-500 font-mono text-xs select-none">
                ...
                <p className="text-amber-500 font-black uppercase tracking-wider mb-2">
                  Monitor Standby
                </p>
                <p className="max-w-xs leading-relaxed opacity-60">
                  Hover your cursor over any official news broadcast card on the
                  left to stream the real-time live preview feed.
                </p>
              </div>
            )}
          </div>
        ...
        <div className="fixed inset-0 z-[9999] bg-black/95 backdrop-blur-md flex flex-col items-center justify-center p-4">
          <div className="w-full max-w-4xl max-h-[95vh] bg-gradient-to-br from-[#0c1020] to-[#030712] border-4 border-[#1e293b] rounded-xl overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.8)] relative flex flex-col">
            <div className="bg-gradient-to-r from-[#003366] to-[#001f3f] p-4 border-b-4 border-amber-500 flex-shrink-0 text-center shadow-[0_4px_20px_rgba(0,0,0,0.5)]">
              <h2 className="text-white font-black text-lg sm:text-xl tracking-widest uppercase">
                {activeVideo.title}
              </h2>
            </div>
            ...
            {cancelStep === 0 && (
              <div className="flex-grow flex flex-col min-h-0 overflow-y-auto bg-[#020617] custom-scrollbar-dark">
                <div
                  className={`relative flex-shrink-0 flex items-center justify-center min-h-[320px] max-h-[55vh] bg-black ${activeVideo.videoUrl.endsWith(".mp3") ? "py-10 bg-gradient-to-br from-gray-900 to-black" : ""}`}
                >
                  ...
                  {forcedConsumption && activeVideoTimeLeft > 0 ? (
                    <div className="w-full max-w-md bg-[#030712] border-2 border-amber-500 rounded-lg p-4 text-amber-400 text-xs sm:text-sm font-black uppercase tracking-widest animate-pulse flex flex-col items-center gap-2 shadow-[0_0_15px_rgba(245,158,11,0.2)]">
                      ...
                      <span className="text-2xl font-mono tracking-widest">
                        {activeVideoTimeLeft}s remaining
                      </span>
                    </div>
                  ) : (
                    <>
            ...
            {cancelStep === 1 && (
              <div className="bg-gradient-to-b from-[#0b0f19] to-[#02050f] p-6 sm:p-8 text-center border-t-4 border-red-700 flex-grow flex flex-col justify-center min-h-0 overflow-y-auto custom-scrollbar-dark">
                <h3 className="text-red-500 font-black text-xl sm:text-3xl mb-4 animate-bounce flex-shrink-0 tracking-wider">
                  ⚠️ WAIT! MANDATORY DETAILED NEWS ⚠️
                </h3>
                ...
                <div className="text-left bg-[#030712] border-2 border-red-950 shadow-[inset_0_0_30px_rgba(220,38,38,0.15)] rounded-lg p-5 sm:p-6 text-[#f8fafc] space-y-4 mb-6 overflow-y-auto font-mono text-sm sm:text-base flex-grow min-h-[180px] custom-scrollbar-dark">
                  ...
                  {activeVideo.cancelMessages.map((msg, idx) => (
                    <div
                      key={idx}
                      className="flex gap-3 leading-relaxed border-b border-red-950/20 pb-2"
                    >
                  ...
                  <p className="text-white font-black mt-6 pt-4 border-t border-red-950/60 leading-snug">
                    Do you STILL wish to abandon your civic duty and close this
                    official state broadcast?
                  </p>
                </div>
                  ...
                  <button
                    onClick={() => {
                      if (forcedConsumption && !watchedVideos[activeVideo.id]) {
                        alert(
                          `❌ SHUTDOWN VIOLATION! You have not completed the mandatory 10-second viewing phase for this broadcast. Close sequence aborted.`,
                        )
                        setCancelStep(0)
                      } else {
                        setCancelStep(2)
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-auto flex-shrink-0 w-full max-w-xl mx-auto">
                  ...
                  <button
                    onClick={() => {
                      ...
                      const isCorrect = quiz.answers.some(
                        (ans) => cleanAnswer === ans.toLowerCase().trim(),
                      )

                      if (isCorrect && cleanAnswer !== "") {
                        alert(
                          "🎉 COGNITIVE EXCELLENCE! Your answer is verified by the Ministry of Information. You are approved to close the broadcast.",
                        )
                        setActiveVideo(null)
                      } else {
                        setQuizError(
                          "🚨 INCORRECT CITIZEN REPORT! You failed the comprehension check. You are clearly not paying attention to state-mandated news. Returning you to the study materials in 3 seconds.",
                        )
                        setTimeout(() => {
                          setCancelStep(1)
                          setQuizAnswer("")
        ...
        <div className="fixed inset-0 z-[10000] bg-black/95 backdrop-blur-md flex flex-col items-center justify-center p-4">
          <div className="w-full max-w-2xl max-h-[95vh] bg-gradient-to-br from-[#1e1b4b] to-[#030712] border-4 border-red-600 rounded-xl p-6 sm:p-8 text-center shadow-[0_0_50px_rgba(220,38,38,0.4)] animate-[pulse_3s_infinite] flex flex-col min-h-0 overflow-y-auto custom-scrollbar-dark">
            ...
            <div className="text-left bg-black/70 border border-red-950 p-5 rounded-lg text-gray-300 space-y-4 mb-6 font-mono text-sm leading-relaxed flex-grow overflow-y-auto min-h-[150px] custom-scrollbar-dark">
              ...
              <p>
                Our algorithms have determined that you have spent more than 10
                seconds idling on this portal without fulfilling your civic duty
                of clicking and consuming verified state media.
              </p>
              ...
              <p className="text-white border-t border-red-950/60 pt-4">
                To lift this sanction, you must type the official Pledge of
                Loyalty exactly as shown below (Copy-Paste is blocked for your
                protection):
              </p>
            ...
            <textarea
              ...
              onPaste={(e) => {
                e.preventDefault()
                alert(
                  "Nice try, Citizen! The Ministry has recorded this attempt at bypass. Typing manually is mandatory.",
                )
              }}
            />
            ...
            <div className="flex flex-col gap-3 flex-shrink-0">
              <button
                ...
                onClick={() => {
                  ...
                  alert(
                    "🚨 LOCKOUT STATUS ACTIVE! Pledge recorded. Your browser has been entered into 'Forced State Media Consumption Mode'. You are barred from leaving this page or clicking services until you have fully consumed all 7 verified news broadcasts for at least 10 seconds each. Go!",
                  )
                }}
              ...
              <button
                onClick={() => {
                  alert(
                    "💸 Fine of ₹2,500 has been successfully auto-debited from your linked Aadhar bank account. However, paying the fine does NOT excuse you from active patriotism! You MUST still manually type the Loyalty Pledge to unlock your session.",
                  )
                }}
              ...
              >
                Or pay ₹2,500 Digital Loitering Fine immediately (Does Not
                Bypass Lock)
              </button>
            </div>
          </div>
      ...
      {showAnnoyingPopup && (
        <div className="fixed inset-0 z-[9998] bg-black/85 flex items-center justify-center p-4">
          <div className="bg-gradient-to-b from-red-950 to-black border-4 border-yellow-500 rounded-xl p-6 max-w-md w-full text-center shadow-[0_0_50px_rgba(234,179,8,0.3)] animate-[bounce_1s_infinite]">
            <span className="text-3xl mb-4 block animate-bounce">
              📢 WARNING #{annoyingPopupCount} 📢
            </span>
            <h3 className="text-yellow-500 font-black text-lg mb-4 uppercase tracking-widest">
              Passive Idling Detected
            </h3>
            <p className="text-gray-300 font-mono text-xs sm:text-sm mb-6 leading-relaxed">
              You have been idling on the dashboard for 20 seconds without
              consuming news. Under sub-section 4B of the Digital Media Act,
              active viewing is highly encouraged. Consuming state media is not
              optional!
            </p>
            <button
              onClick={() => {
          ...
          <div className="max-w-2xl w-full flex flex-col items-center gap-6 z-10">
            ...
            <div className="bg-slate-900/80 border-2 border-red-500/50 p-6 sm:p-8 rounded-xl max-w-xl shadow-[0_0_50px_rgba(239,68,68,0.15)] backdrop-blur-sm relative">
              ...
              <p className="text-xs sm:text-sm text-gray-300 font-mono leading-relaxed mb-6 relative z-10">
                "Dear citizen, you have actively ignored five consecutive
                verified news media consumption directives. Under digital safety
                sub-section 99-Z, your session has been temporarily hijacked.
                Rick Astley has been assigned as your compliance officer. You
                must click the escape button below to surrender your
                insubordination."
              </p>
              ...
              <div className="text-[10px] sm:text-xs text-red-400 font-mono font-bold uppercase relative z-10">
                {buttonEscapes < 10 ? (
                  <span className="animate-pulse">
                    ⚠️ BUTTON IS TRYING TO RUN AWAY! CHASE IT! ESCAPES
                    REMAINING: {10 - buttonEscapes}
                  </span>
                ) : (
                  <span className="text-emerald-400 font-black animate-bounce">
                    ✅ COMPLIANCE ACHIEVED. THE BUTTON HAS SURRENDERED. CLICK IT
                    TO EXIT!
                  </span>
                )}
              </div>
            ...
            <button
              ...
              style={{
                ...
                transition:
                  buttonEscapes < 10
                    ? "all 0.15s cubic-bezier(0.175, 0.885, 0.32, 1.275)"
                    : "none",
              }}
            >
              {buttonEscapes < 10
